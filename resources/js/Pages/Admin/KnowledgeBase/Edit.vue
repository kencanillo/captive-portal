  ...
  <div>
    ...
    <div class="py-12">
      <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="mb-8">
          <h1 class="text-2xl font-semibold text-gray-900">Edit Knowledge Base Article</h1>
          <p class="mt-2 text-gray-600">Update the technical article content and metadata.</p>
        </div>
...
const tagInput = ref(props.article.tags ? props.article.tags.join(', ') : '')
...
function submit() {
  form.put(route('admin.knowledge-base.update', props.article))
}
</script>
